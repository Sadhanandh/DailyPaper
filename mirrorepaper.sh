...
#		Mirror (MM) Daily downloader
#
#		Add this to your cron job as a daily script and this does its job
#
#		This checks your environment variable $ME to save the pdf
...
#max=$(expr "$side" : ".*page\s*=\s*[\'|\"]\{0,1\}\([0-9]*\)")
